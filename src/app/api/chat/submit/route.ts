...
export async function POST(req: Request) {
	try {
		...
		// Always use external worker for production
		// Inline processing removed - not compatible with Vercel serverless limits
...
// Inline processing removed - not compatible with Vercel serverless limits
// All processing now handled by external worker service
